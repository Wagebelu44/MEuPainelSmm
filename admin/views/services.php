...
<div class="container-fluid">
   <ul class="nav nav-tabs nav-tabs__service"><br>
      ...
      <li class="p-b"><button class="btn btn-default m-l" data-toggle="modal" data-target="#modalDiv" data-action="new_subscriptions">Nova Serviço automático</button></li>
	  ...
	  <li class="p-b"><a class="btn btn-default m-l" href="admin/services?siralama=asc">Preço crescente</a></li>
	  <li class="p-b"><a class="btn btn-default m-l" href="admin/services?siralama=desc">Preço decrescente</a></li>
	  
	  
      <li class="pull-right">
        <button class="btn btn-default m-l" data-toggle="modal" data-target="#modalDiv" data-action="import_services">Serviços de Importação</button>
      </li>
      <li class="pull-right">
      ...
      <table class="service-block__header" id="sticker">
         <thead>
             <th class="checkAll-th service-block__checker null">
                 <div class="checkAll-holder">
                  ...
                  <div class="action-block">
                    <ul class="action-list">
                       <li><span class="countOrders"></span> Serviços Selecionados</li>
                       <li>
                         <div class="dropdown">
                           <button type="button" class="btn btn-default btn-xs dropdown-toggle btn-xs-caret" data-toggle="dropdown"> operações<span class="caret"></span></button>
                           <ul class="dropdown-menu">
                             <li>
                                <a class="bulkorder" data-type="active">Ative todos os serviços</a>
                                <a class="bulkorder" data-type="deactive">Desativar todos os serviços</a>
                                <a class="bulkorder" data-type="secret">Tornar todos os serviços secretos</a>
                                <a class="bulkorder" data-type="desecret">Remover tudo dos serviços secretos</a>
                                <a class="bulkorder" data-type="del_price">Excluir todos os preços personalizados</a>
                                <a class="bulkorder" data-type="del_service">Excluir todos os serviços</a>
                              </li>
                           </ul>
                         </div>
                       </li>
               ...
               <th class="service-block__service">Serviço</th>
               <th class="service-block__type">
                  tipo de serviço
               </th>
               <th class="service-block__provider">Fornecedor</th>
               <th class="service-block__rate">Preço</th>
               <th class="service-block__minorder">Minimo</th>
               <th class="service-block__minorder">Maximo</th>
                        ...
                        <div class="dropdown-inline">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li><a href="<?php echo site_url("admin/services/".$type."/".$services[0]["category_id"]) ?>">Desativar categoria <?php if( $services[0]["category_type"] == 1 ): echo "Ativar/Desativar"; else: echo ""; endif; ?></a></li>
                                            ...
                                            <td class="service-block__action">
                                              <div class="dropdown pull-right">
                                                ...
                                                <ul class="dropdown-menu">
                                                  ...
                                                  <li><a style="cursor:pointer;"  data-toggle="modal" data-target="#modalDiv" data-action="edit_description" data-id="<?=$services[$i]["service_id"]?>">Edite a Descrição</a></li>
                                                  ...
                                                  <li><a href="<?php echo site_url("admin/services/del_price/".$services[$i]["service_id"]) ?>">Excluir preço</a></li>
                                                         <li><a href="<?php echo site_url("admin/services/delete/".$services[$i]["service_id"]) ?>">Excluir serviço</a></li>
                                                </ul>
                                              </div>
                                            </td>
                                          <?php endif; ?>
