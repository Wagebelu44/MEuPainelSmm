<?php
  ...
  $menuList = ["Configurações Gerais"=>"general","Configurações de Meta (SEO)"=>"meta","Postagens da página"=>"pages","Configurações de pagamento"=>"payment-methods","Contas bancárias"=>"bank-accounts","Bônus de pagamento"=>"payment-bonuses","Configurações de notificação"=>"alert","Fornecedores"=>"providers","editor de linguagem"=>"language","editor de tema"=>"themes"];
